...
function runFinal() {
  ...
  if (maxTemp >78 && limitsAC === 'Yes') {
    msg = `<p>💡 You sometimes limit use of your AC because of the cost, but on ` + tempLabel + ` days like today, <strong>it's time to turn it on</strong>. Using AC for just a few hours a day on 'low cool' or 78 degrees can keep your home from getting dangerously hot. Find out if you're eligible for <a href='www.coned.com/en/accounts-billing/payment-plans-assistance/help-paying-your-bill'>Con Ed's Energy Affordability Program</a>, which can help make air conditioning your home more affordable. You can also <a href="https://finder.nyc.gov/coolingcenters/">find an air-conditioned space to visit</a>.</p>`
    finalMessageText.innerHTML+= msg + '<hr class="my-2">'
  }
  ...
  if (aqi === 2 && sensitiveGroup === 'Yes') {
    msg = `<p>💡 The air quality is moderate, but <strong>you may be more sensitive to pollution</strong>. If you spend time outdoors, follow routine precautions to manage any existing conditions.</p>`
    finalMessageText.innerHTML+= msg + '<hr class="my-2">'
  }
  ...
  if ((maxTemp > 70 && aqi > 3 && hasAC === 'Yes')
    ...
    msg = `<p>‼️ The air quality is unhealthy today. Keep your windows closed, and use your AC if it gets too hot inside. Keep the AC vent closed, or use "recirculate" mode, which can help filter the air."</p>`
    finalMessageText.innerHTML+= msg + '<hr class="my-2">'
    }
