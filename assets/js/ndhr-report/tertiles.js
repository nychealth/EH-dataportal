...
// it, scoring a district above its reference value as comp-good exactly when the flag is
...
// Compares a district value against a borough or city value, with the judgment class.
...
const getComparison = (districtVal, refVal, rankReverse) => {

    // Parse defensively because the source payload can contain string numerics
    const n = Number(districtVal);
