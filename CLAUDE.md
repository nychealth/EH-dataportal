...
`assets/scss/_custom.scss` on 2026-08-15, under a "Neighborhood Reports topic SPA" heading, so a
reader looking in `nr-topic-spa.html` for why an accordion header is white will not find it there.
