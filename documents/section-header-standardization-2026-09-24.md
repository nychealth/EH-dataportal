...
**Status as of 2026-09-24: all six steps done; the work is in `7a995427a1`.** That commit also carries the edits Chris made before this ledger (Data Features `df-accent` + `fa-chart-bar`, 4-space re-indent of `df-front-block.html` and `aqe.html`); both sets were verified together. The `row my-2` spacing edits Chris made on three section pages were superseded by `section-header.html`.
...
| 2 | `data/globals/sections.yml`, `partials/section-icon.html`, `partials/section-header.html`, `.section-header` SCSS (theme.scss, "Section styles") | `7a995427a1` | **DONE 2026-09-24** | covered by step 5 |
| 3 | Convert the 5 section pages to `section-header.html`. DS and DF descriptions moved from the templates into their `_index.md` bodies; DE passes `"description" false` because its `.Content` shares a row with the sidebar | `7a995427a1` | **DONE 2026-09-24** | covered by step 5 |
| 4 | Single-page H1s call `section-icon.html` (27 edits in 26 files via one count-checked script) | `7a995427a1` | **DONE 2026-09-24** | covered by step 5 |
...
| 6 | Commit, on Chris's say-so | `7a995427a1` | **DONE 2026-09-24** | the `restaurant-grades` / `restaurants` layouts' missing H1 went to `site-wide-audit-2026-06-27.md` §20.1 |

**Closed 2026-09-24: all six steps landed in `7a995427a1`.**
