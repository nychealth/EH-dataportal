...
aboutTheData: 'Data for PM2.5 and NO2 are from 2023. Data for industrial areas are from 2022. Data on commercial cooking, traffic, and buildings are from 2019.  For details on data sources and measurements, see <a href="../nyccas">NYCCAS Annual Report</a>.</p><p><a href="aqe-nta.csv"><i class="fas fa-download mr-1" aria-hidden="true"></i>Download data<i class="fas fa-file-csv ml-1" aria-hidden="true"></i></a>.</p>'
---
