...
An update to the original Active Design Guidelines (2010), ADG 2.0 provides a more holistic lens to the design of the built environment and its impact on health and includes strategies that promote physical and mental health, social cohesion, climate resilience, safety and civic life. The update puts health equity at the core of all guidelines and focuses on accessibility, quality and authentic community engagement.
