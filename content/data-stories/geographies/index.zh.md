...
例如，深入研究哮喘数据页面，您会发现基于UHF34社区方案划分的[患有哮喘的成人]({{< relURL >}}data-explorer/asthma/?id=18)数据、基于UHF42社区方案划分的[患有哮喘的公立学校儿童]({{< relURL >}}data-explorer/asthma/?id=2147)数据以及基于NTA方案划分的[哮喘急诊科就诊人数]({{< relURL >}}data-explorer/asthma/?id=2384)数据。门户网站上提供的其他数据由CD、邮编、PUMA划分，有时甚至依据警察辖区划分。这些社区方案是什么，为什么我们使用这一种而不是另一种，为什么整个系统不一致？
