...
PM2.5, or fine particles, are a major form of air pollution that can harm health. PM2.5 is emitted by fuel combustion – from vehicles, building boilers, restaurants, and other sources. We track PM2.5 using [our network of real-time air quality monitors](../data-features/realtime-air-quality). [About 14% of the city’s PM2.5 comes from traffic](../data-stories/traffic-and-air-pollution).  
